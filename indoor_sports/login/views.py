...
#     """
#     print("Logging out user/admin. Clearing session data.")
#     logout(request)
...
def login_view(request):
    ...
    if request.method == "POST":
        ...
        if user and (check_password(password, user.password) or password == user.password):
            ...
            if booking is not None and booking.submitted_review is False:
                # print("printing booking details")
                # print(booking.booking_date)
                # print(booking.user)
                # print("last booking details for location", booking.location)
                return redirect('reviews_by_location_booking', booking_id=booking.booking_id, location_id=booking.location.location_id, sport_id=booking.sport.sport_id)
